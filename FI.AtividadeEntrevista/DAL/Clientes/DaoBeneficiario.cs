...
namespace FI.AtividadeEntrevista.DAL.Clientes
{
    internal class DaoBeneficiario : AcessoDados
    {
        ...
        {
            List<System.Data.SqlClient.SqlParameter> parametrosExcluir = new List<System.Data.SqlClient.SqlParameter>();
            parametrosExcluir.Add(new System.Data.SqlClient.SqlParameter("@IDCliente", idCliente));
            base.Executar("FI_SP_ExcluirBeneficiarios", parametrosExcluir);
        ...
        internal List<Beneficiario> Pesquisa(long idCliente, int iniciarEm, int quantidade, string campoOrdenacao, bool crescente, out int qtd)
        {
            ...
            int qtdBeneficiarios = 0;

            if (ds.Tables.Count > 1 && ds.Tables[1].Rows.Count > 0)
                int.TryParse(ds.Tables[1].Rows[0][0].ToString(), out qtdBeneficiarios);

            qtd = qtdBeneficiarios;
